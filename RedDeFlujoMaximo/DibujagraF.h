	...
	void tamaño(Graphics^ g)
	{
		...
		for (int i = 0; i < Nodos.size(); i++)
		{
			...
			for (int j = 0; j < ListaArista.size(); j++)
			{
				...
				if(ListaArista[j].getcapacidad()>99)
				{
					g->DrawString("" + ListaArista[j].getcapacidad(), mifuente, Brushes::Red, mediox, medioy);
					g->DrawString("" + "/", mifuente, Brushes::Green, mediox + 28, medioy);
					g->DrawString("" + ListaArista[j].getflujo(), mifuente, Brushes::Blue, mediox+34, medioy);
				}
				if (ListaArista[j].getcapacidad() <100&& ListaArista[j].getcapacidad()>9)
				{
					g->DrawString("" + ListaArista[j].getcapacidad(), mifuente, Brushes::Red, mediox, medioy);
					g->DrawString("" + "/", mifuente, Brushes::Green, mediox + 18, medioy);
					g->DrawString("" + ListaArista[j].getflujo(), mifuente, Brushes::Blue, mediox+23, medioy);
				}
				if ( ListaArista[j].getcapacidad() <9)
				{
					g->DrawString("" + ListaArista[j].getcapacidad(), mifuente, Brushes::Red, mediox, medioy);
					g->DrawString("" + "/", mifuente, Brushes::Green, mediox + 8, medioy);
					g->DrawString("" + ListaArista[j].getflujo(), mifuente, Brushes::Blue, mediox + 13, medioy);
				}
